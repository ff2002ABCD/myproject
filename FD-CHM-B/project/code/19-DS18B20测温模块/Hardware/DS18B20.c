...
#define DQ_H     GPIO_SetBits(GPIOB,GPIO_Pin_1)        			//PB1拉高
#define DQ_L     GPIO_ResetBits(GPIOB,GPIO_Pin_1)						//PB1拉低
#define DQ_Read  GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_1)    //PB1读取
