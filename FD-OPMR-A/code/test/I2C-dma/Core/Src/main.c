...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	HAL_StatusTypeDef status;
			uint8_t data[3];
  uint16_t dac_value0 = 2047;  // 12-bit value (0-4095)
//	data[0]=0x40;
...
while (hi2c4.State != HAL_I2C_STATE_READY){};
		status=HAL_I2C_Mem_Write_DMA(&hi2c4, 0x60<<1, 0x40, I2C_MEMADD_SIZE_8BIT, data, 2);
	while (HAL_I2C_GetState(&hi2c4) != HAL_I2C_STATE_READY){};
//    dac_controller_init();
//    set_waveform_parameters(WAVE_SINE, 50, 2000);
//    update_timer_frequency(50);
...
//		set_waveform_parameters(wave_type, 20, 2000);  // 20Hz
//		update_timer_frequency(20);
  }
  /* USER CODE END 3 */
}
