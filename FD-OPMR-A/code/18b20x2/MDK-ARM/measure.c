...
#include "stdlib.h"
#include "control.h"
uint16_t voltage_table[10]={10000,5000,2000,1000,500,200,100,50,20,10};
uint32_t time_table[21]={100000000,50000000,20000000,10000000,5000000,2000000,1000000,500000,200000,100000,50000,20000,10000,5000,2000};
