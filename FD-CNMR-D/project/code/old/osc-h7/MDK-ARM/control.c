...
//		printf("\x01\xff\xff\xff");//确保透传结束
//	}
	//printf("t3.txt=\"%d\"\xFF\xFF\xFF",Encoder_Count);
//	renew_data();
	//菜单——按钮
	...
	{	
		if(HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_2)==GPIO_PIN_SET&&HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_3)==GPIO_PIN_RESET) 
		{
...
//						}break;
	...
	{	
		if(HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_3)==GPIO_PIN_SET&&HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_2)==GPIO_PIN_RESET) 
		{
			//HAL_Delay(50);
			//for(int i=0;i<200;i++) printf("\x01\xff\xff\xff");//确保透传结束
			//delay_ms(10);
...
//						}break;
	...
	{
		if(HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_8)==GPIO_PIN_SET&&HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_9)==GPIO_PIN_RESET)
		{
	...
	{	
		if(HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_5)==GPIO_PIN_SET&&HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_6)==GPIO_PIN_RESET) 
		{
			printf("shunshizheng\xFF\xFF\xFF");
			switch(menu2_status)
			{
