...
/* 
	...
	Note：8080接口 和 FSMC接口 在源文件中，函数定义都是一样的。只是函数内部的实现方式不一样。
*/
...
/* ===================================================== */
// 描述：写数据函数 可以替代LCD_WR_DATA宏,拿时间换空间.
// 参数：data:寄存器值
// 返回值：
/* ===================================================== */
...
/* ===================================================== */
// 描述：在指定区域内填充指定颜色块 区域大小为:(ex-sx+1)*(ey-sy+1)
// 参数：(sx,sy),(ex,ey):填充矩形对角坐标
//		 color:要填充的颜色
// 返回值：
/* ===================================================== */
