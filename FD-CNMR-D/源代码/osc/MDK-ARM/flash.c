...
uint32_t Flash_WData_1[8] ={0xAAAAAAAA,0xBBBBBBBB,0xCCCCCCCC,0xDDDDDDDD,0xAAAAAAAA,0xAAAAAAAA,0xAAAAAAAA,0xAAAAAAAA};
...
{	
	Flash_WData_1[0] = current_offset+100;
}
...
void load_current()
{
	current_offset=*(__IO uint32_t*)0x08019100-100;
}
