...
void MX_TIM1_Init(void)
{
  ...
  if (HAL_TIMEx_RemapConfig(&htim1, TIM_TIM1_ETR_ADC1_AWD1) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    /* TIM1 DMA Init */
    /* TIM1_CH2 Init */
    hdma_tim1_ch2.Instance = DMA1_Stream2;
    ...
    /* TIM1_CH4 Init */
    hdma_tim1_ch4.Instance = DMA1_Stream4;
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    /* TIM2_UP Init */
    hdma_tim2_up.Instance = DMA2_Stream4;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = DIO_CLKA_Pin|DIO_CLKB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
