...
class SurfaceTensionApp(QMainWindow):
    ...
    def init_left_area(self):
       ...
       # 左侧显示框
        ...
        self.left_display_layout.setContentsMargins(20, 0, 0, 55)  # 设置整体边距
        self.left_display_frame.setLayout(self.left_display_layout)
        
        # 左侧显示框内容
        self.display_box = QGroupBox("")
        # 设置大小
        self.display_box.setFixedSize(280, 200)  # 固定大小
        ...
        self.measurement_layout.setContentsMargins(0, 0, 0, 0)  # 添加边距
