...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
//extern int flag,flag1,flag2,flag3,flag4;
extern int ADC_flag;
extern int dmatxflag;
extern TIM_HandleTypeDef htim8,htim1;
...
//	if(CH1_status==1&&CH2_status==0)
//	{
//		printf("\x01\xff\xff\xff");//确保透传结束
//		CH1_status=0;
//		CH2_status=1;
//	}
//	else if(CH2_status==1&&CH1_status==0)
//	{
//		printf("\x01\xff\xff\xff");//确保透传结束
//		CH2_status=0;
