...
****************************************
*/
/* CH375评估板演示程序: 演示USB-HOST主机接口和USB-DEVICE设备接口的应用 */
/* MCS-51单片机C语言的示例程序, 适用于89C52或者更大程序空间的单片机,也适用于ATMEL/PHILIPS/SST等具有1KB内部RAM的单片机 */

/* 关于本程序中的CH375主机接口: HOST.C
       可以连接U盘, 支持U盘文件系统FAT12/FAT16/FAT32, 容量不限,
       插入U盘后, 该程序将U盘中的/C51/CH375HFT.C文件中的前600个字符显示出来,
       ...
       计算机端可以通过串口监控/调试工具软件以9600bps查看演示情况, 也可以使用CH341的串口工具或者CH375模块的演示工具 */
/* 关于本程序中的CH375设备接口: DEVICE.C
       采用请求+应答模式通讯结构, 强调可靠性和交互性, 不追求传输速度,
       计算机端可以通过CH372/CH375的调试工具中的MCS51监控工具程序CH37XDBG.EXE实现对MCS51单片机的"完全"控制,
