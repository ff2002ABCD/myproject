...
UINT8 znFAT_Device_Read_Sector(UINT32 addr,UINT8 *buffer)
{
 ...
 {
  case 0:
	      // while(SD1_Read_Sector(addr,buffer));
					 while(CH375_ReadSector(addr,buffer));
		     break;
  //case 1:
...
UINT8 znFAT_Device_Write_Sector(UINT32 addr,UINT8 *buffer) 
{
 ...
 {
  case 0:
	       //while(SD1_Write_Sector(addr,buffer));
					while(CH375_WriteSector(addr,buffer));
		     break;
  //case 1:
