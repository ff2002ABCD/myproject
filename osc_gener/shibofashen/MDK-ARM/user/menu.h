...
#define time_grid_max 16
#define mag_scale_max 9
#define light_scale_max 9
#define temp_light_max 110
#define temp_light_min 20
#define temp_pool_max 80
#define temp_pool_min 20
